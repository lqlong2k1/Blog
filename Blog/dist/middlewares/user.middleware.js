...
exports.default = {
    ...
    checkDuplicatePhoneNumber(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const phoneNumber = yield prisma_1.default.users.findFirst({
    ...
    checkDuplicateEmail(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const email = yield prisma_1.default.users.findFirst({
    ...
    checkUserAuthentication: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
